...
def load_data(ticker, year='2023'):
    ...
    keys = [
        ...
        'Normalized Income', 'Total Operating Income As Reported',
        'Basic Average Shares', 'Net Income Common Stockholders', 'Net Income',
        'Minority Interests', 'Net Income Including Noncontrolling Interests',
        'Net Income Continuous Operations', 'Tax Provision', 'Pretax Income',
        'Other Income Expense', 'Impairment Of Capital Assets',
    ...
    if clickData is not None:
        ...
        if not matched_tickers.empty:
            ...
            if financial_metrics:
                ...
                fig.add_annotation(
                    dict(font=dict(color="steelblue", size=12), x=0.08, y=0.96, showarrow=False, text='<b>$69.1B</b>'))

                # Gross Profit
                fig.add_annotation(
                    dict(font=dict(color="green", size=12), x=0.315, y=0.99, showarrow=False,
                ...
                # Operating Profit
                fig.add_annotation(
                    dict(font=dict(color="green", size=12), x=0.61, y=1.05, showarrow=False,
                         text='<b>Operating Profit</b>'))
                fig.add_annotation(
                    dict(font=dict(color="green", size=12), x=0.61, y=1.02, showarrow=False, text='<b>$16.1B</b>'))

                # Net Profit
                fig.add_annotation(
                    dict(font=dict(color="green", size=12), x=0.95, y=1.05, showarrow=False, text='<b>Net Profit</b>'))
                fig.add_annotation(
                    dict(font=dict(color="green", size=12), x=0.94, y=1, showarrow=False, text='<b>$13.9B</b>'))

                # Operating Profit Tax
                fig.add_annotation(
                    dict(font=dict(color="maroon", size=12), x=0.93, y=0.9, showarrow=False, text='<b>Tax</b>'))
                fig.add_annotation(
                    dict(font=dict(color="maroon", size=12), x=0.935, y=0.85, showarrow=False, text='<b>$2.3B</b>'))

                # Operating Profit Other
                fig.add_annotation(
                    dict(font=dict(color="maroon", size=12), x=0.935, y=0.75, showarrow=False, text='<b>Other</b>'))
                fig.add_annotation(
                    dict(font=dict(color="maroon", size=12), x=0.935, y=0.70, showarrow=False, text='<b>$0.9B</b>'))

                # Operating Profit R&D
                fig.add_annotation(
                    dict(font=dict(color="maroon", size=12), x=0.93, y=0.58, showarrow=False, text='<b>R&D</b>'))
                fig.add_annotation(
                    dict(font=dict(color="maroon", size=12), x=0.94, y=0.53, showarrow=False, text='<b>$10.3B</b>'))

                # Operating Profit S&M
                fig.add_annotation(
                    dict(font=dict(color="maroon", size=12), x=0.93, y=0.43, showarrow=False, text='<b>S&M</b>'))
                fig.add_annotation(
                    dict(font=dict(color="maroon", size=12), x=0.935, y=0.38, showarrow=False, text='<b>$6.9B</b>'))

                # Operating Profit G&A
                fig.add_annotation(
                    dict(font=dict(color="maroon", size=12), x=0.93, y=0.25, showarrow=False, text='<b>G&A</b>'))
                fig.add_annotation(
                    dict(font=dict(color="maroon", size=12), x=0.935, y=0.20, showarrow=False, text='<b>$3.6B</b>'))

                # Operating Expenses
                fig.add_annotation(
                    dict(font=dict(color="maroon", size=12), x=0.59, y=0.47, showarrow=False,
                         text='<b>Operating<br>expenses</b>'))
                fig.add_annotation(
                    dict(font=dict(color="maroon", size=12), x=0.59, y=0.41, showarrow=False, text='<b>$20.8B</b>'))

                # Cost of Revenues
                fig.add_annotation(
                    dict(font=dict(color="maroon", size=12), x=0.34, y=0.08, showarrow=False,
                         text='<b>Cost of<br>Revenues</b>'))
                fig.add_annotation(
                    dict(font=dict(color="maroon", size=12), x=0.34, y=0.05, showarrow=False, text='<b>$31.2B</b>'))

                # Cost of Revenues - Others
                fig.add_annotation(
                    dict(font=dict(color="maroon", size=12), x=0.68, y=0.10, showarrow=False, text='<b>Others</b>'))
                fig.add_annotation(
                    dict(font=dict(color="maroon", size=12), x=0.68, y=0.05, showarrow=False, text='<b>$19.3B</b>'))
